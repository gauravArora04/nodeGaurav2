    ...
    render() {
        return (
            ...
            <ul className='collapsible flow-text'>
                <li className='active'>
                    <h4 className='collapsible-header'><i className="material-icons">search</i>How to Login?</h4>
                ...
                <li>
                    <h4 className='collapsible-header'><i className="material-icons">search</i>How do I create a new survey?</h4>
                ...
                <li>
                    <h4 className='collapsible-header'><i className="material-icons">search</i>How do I add credits in my account?</h4>
